    ...
    return (
        <div className={['flex items-center', className].join(' ')}>
            <input
                ...
                type="checkbox"
                className={[
                    'h-6 w-6 shadow-sm transition duration-150 ease-in-out bg-field rounded-1 border-hairline border-divider focus:ring-neutral focus:border-divider focus:outline-none focus:ring focus:ring-offset focus:ring-offset-primary disabled:opacity-50',
